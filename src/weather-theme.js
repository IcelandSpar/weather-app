...
export async function currentWeatherTheme(condition) {
    ...
    if(await condition.includes('cloudy') || await condition.includes('Overcast') || await condition.includes('Cloud')) {
    ...
    } else if (await condition.includes('storm') || await condition.includes('lightning') || await condition.includes('thunder')) {
    ...
    } else if (await condition.includes('snow') || await condition.includes('freeze') || await condition.includes('hail')) {
